<nav class="col-12 navbar navbar-expand-md navbar-dark bg-dark" id="subNav">
    <div class="container-fluid">
        ...
        <a href="/" class="navbar-brand h1 text-white text-uppercase">
            the Tracker App
        </a>
    </div>
</nav>
...
<div class="col-md-2 navbar navbar-expand-lg navbar-dark bg-dark">
    <nav class="flex-column collapse navbar-collapse" id="sidebar">
        <ul>
            ...
            <li class="nav-item p-3 d-flex">
                <span>
                    <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-folder2-open" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                            d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v.64c.57.265.94.876.856 1.546l-.64 5.124A2.5 2.5 0 0 1 12.733 15H3.266a2.5 2.5 0 0 1-2.481-2.19l-.64-5.124A1.5 1.5 0 0 1 1 6.14V3.5zM2 6h12v-.5a.5.5 0 0 0-.5-.5H9c-.964 0-1.71-.629-2.174-1.154C6.374 3.334 5.82 3 5.264 3H2.5a.5.5 0 0 0-.5.5V6zm-.367 1a.5.5 0 0 0-.496.562l.64 5.124A1.5 1.5 0 0 0 3.266 14h9.468a1.5 1.5 0 0 0 1.489-1.314l.64-5.124A.5.5 0 0 0 14.367 7H1.633z" />
                    </svg>
                </span>
                <a class="nav-link text-white" href="/projects/list" title="view all projects">Projects</a>
            </li>
            <li class="nav-item p-3 d-flex">
                <span>
                    <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-files" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                ...
                <a class="nav-link text-white" href="/tasks/list" title="view all tasks">Tasks</a>
            </li>

            <li class="nav-item p-3 d-flex">
                <div>
                    <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-bar-chart" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                ...
                <div><a class="nav-link text-white" href="/reports">Reports</a></div>
            </li>
        </ul>
    </nav>
</div>